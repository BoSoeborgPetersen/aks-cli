...
CheckNumberRange $windowsNodeCount "windows node count" -min 2 -max 100
...
AzAksCommand "nodepool add --cluster-name $cluster -n $windowsNodepool -g $resourceGroup -c $windowsNodeCount -s $windowsNodeSize -k $version --os-type Windows"

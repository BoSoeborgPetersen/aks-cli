...
WantToContinue "Install Nginx (Helm chart), using nginx config file with prefix 'identity', with Azure public ip"
AksCommand nginx install -configPrefix identity -addIp

...
WriteAndSetUsage "aks setup communicate" ([ordered]@{
...
AksCommand nginx install -deployment masterdata -configPrefix communicate -addIp
...
AksCommand nginx install -deployment dme -configPrefix communicate -addIp

...
$azureAccountId = $selectedAccount.id
...
$sourcePublicIpId = "/subscriptions/$azureAccountId/resourceGroups/$sourceResourceGroup/providers/Microsoft.Network/publicIPAddresses/$sourcePublicIpName"

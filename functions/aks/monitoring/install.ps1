...
Helm3Command "install prometheus stable/prometheus --namespace monitoring -f config\helm-prometheus.yaml"
...
Helm3Command "install grafana stable/grafana --namespace monitoring -f config\helm-grafana.yaml"
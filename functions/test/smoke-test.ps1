...
# TestCommand "aks" # TODO: How to not show output.
...
# TestCommand "aks delete -whatif" # TODO: How to skip prompt.
# TestCommand "aks describe po status" # TODO: Get deployment before.
# TestCommand "aks edit" # TODO: How to exit.
TestCommand "aks get po"
TestCommand "aks logs $kubernetesDeployment -index 1" # TODO: Hot to exit Stern (and how to hide output from Stern).
# TestCommand "aks shell $kubernetesDeployment" "exit" # TODO: How to exit.
# TestCommand "aks switch" # TODO: How to test!!!.
TestCommand "aks top no"
# TestCommand "aks upgrade -whatif" # TODO: How to skip prompt.
